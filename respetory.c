...
typedef INT                    int;
typedef LONG_INT               long int;
typedef LINT                   long int;
typedef LONG_LONG_INT          long long int;
typedef LLINT                  long long int;
typedef FLOAT                  float;
typedef DOUBLE                 double;
typedef SHORT                  short;
typedef UNSIGNED_INT           unsigned int;
typedef UINT                   unsigned int;
typedef UNSIGNED_UNSIGNED_INT  unsigned unsigned int;
typedef UUINT                  unsigned unsigned int;
typedef UNSIGNED_LONG_INT      unsigned long int;
typedef UNSIGNED_LONG_LONG_INT unsigned long long int;

#define EXIT_SUCCESS 0
#define EXIT_FAILURE 1

#define ASM_STDIN 13
#define ASM_ENDL 0x0D, 0x0A
